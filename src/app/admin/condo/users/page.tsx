            ...
            <div className="max-w-7xl mx-auto">
                ...
                <header className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-300 text-sm">Gestión de Residentes</p>
                    </div>
                    <CreateResidentModal />
                </header>
                ...
                {residents.length === 0 ? (
                    <EmptyState
                        ...
                        description="Empezá agregando los propietarios e inquilinos de las unidades del condominio. Cada residente podrá acceder al sistema con su email."
                        iconColor="text-blue-500"
                        action={<CreateResidentModal />}
                    />
                ) : (
                    <>
