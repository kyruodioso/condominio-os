                ...
                <div className="flex-1 flex flex-col lg:min-h-0 lg:flex-row gap-8">
                    ...
                    <div className="lg:hidden flex-none mb-4 space-y-4">
                        ...
                        <div className="flex overflow-x-auto gap-3 pb-2 scrollbar-hide">
                            ...
                            <Link href="/admin/servicios" className="flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-xs font-bold text-gray-400 whitespace-nowrap">
                                <Truck size={14} /> Servicios
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="hidden lg:block w-80 flex-none h-[calc(100vh-220px)] overflow-y-auto pr-2 custom-scrollbar space-y-4 pb-10">
                        ...
                        {session.user.role === 'STAFF' && session.user.planType !== 'PRO' ? (
                            <div className="bg-gym-gray rounded-3xl p-4 border border-white/5 space-y-2">
                                ...
                                <Link href="/admin/mensajes" className="flex items-center gap-3 p-4 rounded-2xl border transition-all group bg-black/20 text-gray-400 border-white/5 hover:bg-white/5">
